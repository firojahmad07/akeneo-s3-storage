...
define([
  ...
  'spygar-akeneos3storage/template/product/field/media',
  'pim/dialog',
  'oro/mediator',
  'oro/messenger',
  'spygar-akeneos3storage/media-url-generator',
  'jquery.slimbox',
  ...
  return Field.extend({
    ...
    updateModel: function () {
      ...
      $.ajax({
        url: Routing.generate('akeneo_s3_storage_pim_enrich_media_rest_post'),
        type: 'POST',
        data: formData,
        contentType: false,
        cache: false,
