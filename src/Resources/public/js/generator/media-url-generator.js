...
define(['jquery', 'underscore', 'routing'], function ($, _, Routing) {
  return {
    ...
    getMediaShowUrl: function (filePath, filter) {
      ...
      return Routing.generate('akeneo_s3_storage_pim_enrich_media_show', {
        filename: filename,
        filter: filter,
      });
    },
    ...
    getMediaDownloadUrl: function (filePath) {
      var filename = encodeURIComponent(filePath);
      return Routing.generate('akeneo_s3_storage_pim_enrich_media_download', {
        filename: filename,
      });
    },
     ...
     * @return {string}
     */
    getS3MediaUrl: function (filePath) {
      var filename = encodeURIComponent(filePath);
      return Routing.generate('akeneo_s3_storage_pim_enrich_media_s3_url', {
        filename: filename,
      });
    },
  };
