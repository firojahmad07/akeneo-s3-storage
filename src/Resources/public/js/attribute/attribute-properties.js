...
define([
    ...
    return BaseField.extend({
            ...
            this.getTemplateContext().then(
                function (templateContext) {
                    this.$el.html(this.template({
                        ...
                        isIncludeAttribute: this.isIncludeAttribute
                    }));
        ...
        isSelected: function (selectVal, value) {
            return selectVal == value || _.indexOf(selectVal, value) !== -1;
        },

        isHidden: function (attributeProperty) {
            return attributeProperty.config.dependsOn && !this.formdata[attributeProperty.config.dependsOn]
        },

        isIncludeAttribute: function (attributeTypes, currentType) {
            return _.includes(attributeTypes, currentType) || _.includes(attributeTypes, '~')
        }
    });
});